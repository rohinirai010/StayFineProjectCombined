...
export const ReferralMembersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl sm:px-4 py-1.5 sm:py-2">
